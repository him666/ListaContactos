...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { apellido: @contacto.apellido, direccion: @contacto.direccion, nombre: @contacto.nombre, telefono: @contacto.telefono, user_id: @contacto.user_id } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { apellido: @contacto.apellido, direccion: @contacto.direccion, nombre: @contacto.nombre, telefono: @contacto.telefono, user_id: @contacto.user_id } }
